...
val entry_point: Cmx_format.unit_infos list -> Cmm.phrase
val location_table: unit -> Cmm.phrase
...
val global_data: string -> 'a -> Cmm.phrase  (* Cago: use in asmlink to dump locations table *)
